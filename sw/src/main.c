...
static void cmd_help(void)
{
...
#endif
    send_str("RW2 DAC TX diag: [2:1] sample_map 0=native 1=general_preimage 2=old_remap 3=Sundance physical\r\n");
    ...
    send_str("                  firmware default is RW2=0x010000FE for ADC1/DAC bring-up\r\n");
